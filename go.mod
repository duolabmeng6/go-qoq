...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.679 // indirect
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/tmt v1.0.679 // indirect
